...
class CountryNotifier extends StateNotifier<CountryState> {
  ...
  CountryNotifier(this.dbHelper) : super(CountryState()) {
    getCountriesData();
  }
  ...
  Future<void> getCountriesData() async {
    ...
    final List<Map<String, dynamic>> countries =
        await dbHelper.getAllCountries();
  ...
  Future<void> deleteCountry(CountryModel country) async {
    await dbHelper.deleteCountry(country.cca2!);
...
final countryProvider =
  ...
  return CountryNotifier(dbHelper);
});
